...
***********************************************************/	
	...
	//Set Upload directory    
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/network-site/assets/images/profile_pics';
	//Set File name	
...
<div class="main_column column">
    ...
    if($imgSrc){ //if an image has been uploaded display cropping area?>
	    ...
	    <div id="CroppingContainer" style="width:800px; max-height: max-content; position:relative; overflow:hidden; z-index:2001; padding-bottom:0px;">  
	    
	        <div id="CroppingArea" style="width:500px; max-height: fit-content; position:relative; overflow:hidden; margin:40px 0px 40px 40px; border:2px purple solid; float:left;">	
	        ...
	        <div id="InfoArea" style="width:180px; height: auto; position:relative; overflow:hidden; margin:40px 0px 0px 40px; border:0px #666 solid; float:left;">	
	        ...
	        <div id="CropImageForm" style="width:100px; height:30px; float:left; margin:10px 0px 0px 40px;" >  
	            <form action="upload.php" method="post" onsubmit="return checkCoords();">
	                ...
	                <input type="submit" value="Save" id="accept"/>
	            </form>
	        </div>
	        ...
	        <div id="CropImageForm2" style="width:100px; height:30px; float:left; margin:10px 0px 0px 40px;" >  
	            <form action="upload.php" method="post" onsubmit="return cancelCrop();">
	                <input type="submit" value="Cancel" id="danger" />
	            </form>
	        </div>            
