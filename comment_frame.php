...
//store who posted the post into a variable posted to
$posted_to = $row['added_by'];

//INSERT post comment into a database
...
<form action="comment_frame.php?post_id=<?php echo $post_id; ?>" class="comment_form" name="postComment<?php echo $post_id; ?>" method="POST">
	...
	<input type="submit" class="commentSubmit" name="postComment<?php echo $post_id; ?>" value="Post Comment">
</form>
